...
var Slider = function (_Component) {
  ...
  function Slider(props, context) {
    ...
    _this.renderBuffer = function (buffer) {
      var startPos = _this.getPositionFromValue(buffer.start);
      var endPos = _this.getPositionFromValue(buffer.end);
      var width = endPos - startPos || 0;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        buffers.map(function (buffer) {
          return _this2.renderBuffer(buffer);
        }),
